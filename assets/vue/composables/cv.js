...
export default function useCv (){
        ...
        formations: [
            {
                ...
                events: [
                    {
                        group: 'Langages:',
                        title: 'Php, TypeScript, Javascript'
                    },
                    {
                        group: 'Frameworks:',
                        title: 'Symfony 6, Nestjs(Nodejs), Vuejs 3, Ionic 6, Angular X, ElementUI, Bootstrap 5'
                    },
                    {
                        group: 'Base de données:',
                        title: 'Mysql, Sqlite, Redis, Mongodb'
                    },
                    {
                        group: 'Système d\'exploitation:',
                        title: 'Linux Debian 11, Ubuntu 22.04'
                    },
                    {
                        group: 'Autres:',
                        title: 'Git, Docker, Vps'
                    }
                ]
            },
            {
                ...
                events: [
                    {
                        group: '2007-2009 :',
                        title: 'Licence Mathématiques à l’Université de Fianarantsoa (Madagascar)'
                    },
                    {
                        group: '2004-2005 :',
                        title: 'Baccalauréat Scientifique - Mention Bien (Saint François Xavier)'
                    }
                ]
            },
            {
                ...
                events: [
                    {
                        group: 'Langue',
                        title: 'Français(courant) Anglais(moyen)'
                    },
                    {
                        group: 'Sport',
                        title: 'Basket, Foot'
        ...
        experiences: [
            {
                ...
                descriptions:
                    [
                        ...
                        'Développement des  fonctionnalités font end et backend'
                    ],
                technologies: '#Symfony 6, #Vuejs 3, #Postgresql, #Git'
            },
            {
                image: 'img/vestaradio.jpeg',
                job: 'Développeur fullstack Symfony 5 - Vuejs 2',
                company: 'Vestaradio',
                type: 'Freelance',
                date: 'Sept 2020 - Oct 2022',
                place: 'Antananarivo Madagascar',
                title: 'Développement d\'une application web sur la gestion de web radio en ligne en France https://studio.vestaradio.com/',
                descriptions:
                    [
            ...
            },
            {
                ...
                descriptions:  [
                    ...
                    'Accompagner et permettre aux sportifs et cadres de mieux s’insérer dans le monde professionnel (programme personnel, individuel ou collectif)',
            ...
            },
            {
                ...
                descriptions: [
                    ...
                    'Développement des fonctionnalités: Authentification des différentes types d\'utilisateurs, gestion de Cabinet, Collaborateur, Bureau de cabinet, profil utilisateur avec leur droit, envoie de mail, invitation entre cabinet, génération de fichier pdf, importation et exportation de fichier excel, ...',
            ...
            },
            {
                ...
                descriptions: [
                    ...
                    'Développer une application de gestion commerciale: Devis, Commande, Facture, Bon de préparation, gestion d\'article, gestion de stock',
                ],
    ...
    const page = computed(() => state.cv.page )
    const output = computed(() => state.cv.output )

    const download = async () => {
        await dispatch('cv/downloadAction')
